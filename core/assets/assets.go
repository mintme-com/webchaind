		...
		files: map[string]File{
			"/core/config/mainnet.json": File{
				data: []byte{
					...
					0x35, 0x35, 0x2e, 0x38, 0x30, 0x3a, 0x33, 0x31, 0x33, 0x33, 0x39, 0x22,
					...
					0x35, 0x35, 0x2e, 0x31, 0x39, 0x35, 0x3a, 0x33, 0x31, 0x33, 0x33, 0x39,
					0x22, 0x0a, 0x20, 0x20, 0x20, 0x20, 0x5d, 0x0a, 0x7d, 0x0a,
				},
				fi: FileInfo{
					name:    "mainnet.json",
					size:    1438,
					modTime: time.Unix(0, 1525333829263253702),
					isDir:   false,
				},
